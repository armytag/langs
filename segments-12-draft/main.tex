...
\begin{itemize}
    \item 26-33 consonants
    \item 2-4 vowels
    \item Velar nasal contrastive, and allowed word-initially

I will be romanizing the IPA in the following way:

\begin{itemize}
    \item Labialized plosives written with following 'w', \textit{e.g.} /tw/ as <tw>
    \item Palatalized plosives written with following 'y', \textit{e.g.} /pj/ as <py>
    \item Velar nasals written with following 'j', \textit{e.g.} /nj/ as <nj>
    \item Voiceless nasals written with preceding 'h', \textit{e.g.} /m/ as <hm>
    \item Voiceless lateral fricative written as <hl>

Thus, a words such as /hnjibwahl/ are written as <hnjibwahl>
